...
export const MOCK_ACTIVE: Order[] = [
  {
    id: "mock-active-multi",
    storeName: "Allbirds",
    storeLogo: "https://www.google.com/s2/favicons?domain=allbirds.com&sz=64",
    shopifyOrderId: "482517",
    lineItems: JSON.stringify([
      { name: "Tree Dasher 2 — Blizzard / Size 9", imageUrl: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop", quantity: 1, discountedAmount: 19.5 },
      { name: "Wool Runner — Natural Black / Size 8", imageUrl: "https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?w=400&h=400&fit=crop", quantity: 1, discountedAmount: 16.5 },
      { name: "Trail Runner SWT — Mist / Size 10", imageUrl: "https://images.unsplash.com/photo-1539185441755-769473a23570?w=400&h=400&fit=crop", quantity: 1, discountedAmount: 0 },
      { name: "Anytime No Show Sock — Natural White", imageUrl: "https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?w=400&h=400&fit=crop", quantity: 2, discountedAmount: 0 },
      { name: "Wool Jumper — Calm Taupe / M", imageUrl: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400&h=400&fit=crop", quantity: 1, discountedAmount: 0 },
    ]),
